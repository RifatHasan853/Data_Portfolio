...
const Contact = () => {
  ...
  const sendEmail = (e) => {
    ...
    emailjs
      .sendForm("service_9gxr5sh", "template_z6it464", form.current, {
        publicKey: "1eT0jsxuMcC-dzyPM",
      })
      .then(
        () => {
          toast.custom((t) => (
        ...
        <div className="flex flex-col w-full mx-auto items-center justify-center">
          <div className="flex items-center bg-card py-4 xsm:px-6 xsm:py-5 rounded-xl w-11/12 sm:min-w-[500px] mb-10 xl:min-w-[365px] xl:w-fit">
            ...
            <div>
              ...
              <a
                href="mailto:rifathasan.insights@gmail.com"
                className="font-Opensans font-semibold text-button text-sm xsm:text-lg"
              >
                rifathasan.insights@gmail.com
              </a>
            </div>
          </div>
          <div className="flex items-center bg-card py-4 xsm:px-6 xsm:py-5 rounded-xl w-11/12 sm:min-w-[500px] mb-10 xl:min-w-[365px] xl:w-fit">
